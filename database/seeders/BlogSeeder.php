...
Every project gets a `tests/` directory that mirrors the `app/` directory structure. Feature tests for HTTP endpoints, Unit tests for Actions, Services, and DTOs.
