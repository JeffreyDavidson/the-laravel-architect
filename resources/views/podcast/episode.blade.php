            ...
            <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
                <div class="flex flex-col gap-12 lg:flex-row">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        @if ($embedLink || $episode->youtube_url)
                            ...
                            <div class="mb-12">
                                <h2 class="mb-6 flex items-center gap-3 text-2xl font-extrabold">
                                    <span class="podcast-accent-bg-soft flex h-8 w-8 items-center justify-center rounded-lg">
                                        <svg class="podcast-accent-text h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                                    </span>
                                    Show Notes
                                </h2>
                                    ...
                                    <div class="dark:border-surface-border border-t border-gray-200 px-6 py-6 md:px-8">
                                        ...
                                        >
                                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
                                                <label for="episode-transcript-search" class="sr-only"
                                                    >Search transcript</label>
                                                <input
                                        ...
                                        <div
                                            ...
                                            class="podcast-prose prose prose-invert prose-lg prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-headings:font-extrabold prose-a:no-underline hover:prose-a:underline prose-code:font-mono prose-pre:bg-gray-50 dark:prose-pre:bg-surface-control prose-pre:border prose-pre:border-gray-200 dark:prose-pre:border-surface-border prose-li:text-gray-600 dark:prose-li:text-gray-400 prose-p:text-gray-600 dark:prose-p:text-gray-400 max-w-none"
                                        >
                                            {!!
