                            ...
                            <div class="mb-10 flex flex-wrap gap-3">
                                ...
                                @if ($episode->apple_podcasts_url)
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        class="share-btn inline-flex items-center gap-2 rounded-lg border border-[#D56DFB]/20 bg-[#D56DFB]/10 px-4 py-2.5 text-sm font-medium text-[#D56DFB] transition-colors hover:bg-[#D56DFB]/20"
                                    >
