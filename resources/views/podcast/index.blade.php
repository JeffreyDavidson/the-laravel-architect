...
<section class="noise-overlay relative overflow-hidden min-h-[60vh] flex items-center border-b border-gray-200 dark:border-[#1e2a3a]">
    ...
    <div class="absolute inset-0">
        ...
        <div class="hidden dark:block absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full opacity-[0.06] blur-[120px]" style="background: radial-gradient(circle, #9D5175, transparent 70%);"></div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 text-center w-full">
        ...
        <h1 class="text-5xl md:text-7xl font-extrabold mb-5 tracking-tight">
            <span class="bg-gradient-to-r from-gray-900 via-gray-900 to-gray-500 dark:from-white dark:via-white dark:to-gray-400 bg-clip-text text-transparent">Podcasts</span>
        </h1>
        <p class="text-gray-600 dark:text-gray-400 text-lg md:text-xl max-w-2xl mx-auto mb-8">Two shows. One about code, one about life. Both unfiltered.</p>
                    ...
                    <div class="flex flex-col {{ $index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse' }} items-center gap-10">
                        ...
                        <div class="relative flex-shrink-0 w-48 h-48 md:w-60 md:h-60">
                            ...
                            <div class="showcase-artwork relative z-10">
                                ...
                                <img src="{{ $podcast->getFirstMediaUrl('cover_image') }}" alt="{{ $podcast->name }}" class="w-40 h-40 md:w-48 md:h-48 rounded-2xl object-cover shadow-2xl" style="box-shadow: 0 20px 40px {{ $podcast->color }}20;">
                                @else
                        ...
                        {{-- Content --}}
                        <div class="flex-1 min-w-0 text-center {{ $index % 2 === 0 ? 'md:text-left' : 'md:text-right' }}">
                            {{-- Badge --}}
