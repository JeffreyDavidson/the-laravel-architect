...
<div class="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
    ...
    <div class="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full opacity-[0.05] blur-[100px]" style="background: radial-gradient(circle, #9D5175, transparent 70%);"></div>
    ...
    <div class="relative text-center px-4">
        ...
        <div class="flex flex-wrap gap-4 justify-center">
            ...
            <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 px-6 py-3 border border-[#1e2a3a] hover:border-gray-600 text-gray-300 font-semibold rounded-lg transition-colors">
                Read the Blog
            </a>
            <a href="{{ route('contact') }}" class="inline-flex items-center gap-2 px-6 py-3 border border-[#1e2a3a] hover:border-gray-600 text-gray-300 font-semibold rounded-lg transition-colors">
                Contact Me
            </a>
        </div>
    </div>
