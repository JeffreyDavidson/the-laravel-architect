...
@section('content')
    <div class="flex min-h-[80vh] items-center bg-white dark:bg-surface-page">
        <div class="mx-auto grid w-full max-w-7xl gap-8 px-4 py-20 sm:px-6 md:grid-cols-[10rem_minmax(0,1fr)] md:gap-14 lg:px-8">
            <p class="text-brand-600 font-mono text-sm tracking-label uppercase">Error / 404</p>
            <div>
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    <a
                        href="{{ route('home') }}"
                        class="inline-flex items-center gap-2 rounded-lg bg-brand-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-brand-500"
                    >
                    ...
                    <a
                        ...
                        class="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-6 py-3 font-semibold text-gray-700 transition-colors hover:border-gray-400 dark:border-surface-border dark:text-gray-300 dark:hover:border-gray-600"
                    >
                        Read the Blog
                    </a>
                    <a
