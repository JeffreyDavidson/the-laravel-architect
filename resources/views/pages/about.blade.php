...
<style>
    ...
    {{-- Hero — Terminal Style --}}
    <div class="noise-overlay border-b border-[#1e2a3a] relative overflow-hidden">
        {{-- Ghost avatar watermark --}}
        <div class="absolute -right-20 -bottom-20 w-[500px] h-[500px] opacity-[0.04] pointer-events-none" style="mix-blend-mode: lighten;">
            <img src="/images/logo-alternate.jpg" alt="" class="w-full h-full object-contain">
        </div>
        <div class="absolute inset-0 bg-gradient-to-br from-[#4A7FBF]/5 via-transparent to-[#9D5175]/5"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
            <div class="max-w-3xl">
                {{-- Terminal window --}}
                <div class="mb-10 rounded-xl border border-[#1e2a3a] bg-[#0a0e14] overflow-hidden shadow-2xl" style="box-shadow: 0 25px 60px -12px rgba(0,0,0,0.5);">
                    {{-- Title bar --}}
                    <div class="flex items-center gap-2 px-4 py-3 border-b border-[#1e2a3a] bg-[#0D1117]">
                        <div class="flex gap-1.5">
                            <span class="w-3 h-3 rounded-full bg-[#ff5f57]"></span>
                            <span class="w-3 h-3 rounded-full bg-[#febc2e]"></span>
                            <span class="w-3 h-3 rounded-full bg-[#28c840]"></span>
                        </div>
                        <span class="text-xs text-gray-500 font-mono ml-2">~/about-jeffrey</span>
                    </div>
                    {{-- Terminal content --}}
                    <div class="p-5 md:p-6 font-mono text-sm leading-relaxed">
                        <div class="mb-3">
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-300">whoami</span>
                        </div>
                        <div class="text-gray-400 mb-4 pl-3">Jeffrey Davidson — Web Developer, Content Creator, Dad</div>

                        <div class="mb-3">
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-300">cat philosophy.txt</span>
                        </div>
                        <div class="text-gray-400 mb-4 pl-3 italic">"I've spent 15 years learning how to write code<br>that my future self won't hate."</div>

                        <div class="mb-3">
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-300">ls --stack</span>
                        </div>
                        <div class="text-gray-400 mb-4 pl-3">Laravel · PHP · Filament · Livewire · Tailwind · Pest</div>

                        <div class="mb-3">
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-300">cat location.txt</span>
                        </div>
                        <div class="text-gray-400 mb-4 pl-3">Florida 🌴 (formerly Kansas)</div>

                        <div class="mb-3">
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-300">ls --creating</span>
                        </div>
                        <div class="text-gray-400 mb-4 pl-3">
                            <span class="text-[#4A7FBF]">☕</span> Coffee with The Laravel Architect<br>
                            <span class="text-[#9D5175]">☁️</span> Embracing Cloudy Days<br>
                            <span class="text-red-400">▶</span> The Laravel Architect (YouTube)
                        </div>

                        <div>
                            <span class="text-[#4A7FBF]">❯</span> <span class="text-gray-500 animate-pulse">_</span>
                        </div>
                    </div>
                </div>
