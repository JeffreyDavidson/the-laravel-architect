<x-layouts.site :seo-source="$seoSource ?? null" :structured-data="$structuredData ?? []">
    ...
    <section class="hidden" aria-hidden="true">
        <div class="flex w-max animate-[marqueeScroll_30s_linear_infinite] hover:[animation-play-state:paused] motion-reduce:animate-none">
            @for ($i = 0; $i < 4; $i++)
                <div class="[&_svg]:size-7 [&_img]:size-7 [&_svg]:opacity-30 [&_img]:opacity-30 dark:[&_svg]:opacity-40 dark:[&_img]:opacity-40 [&_svg]:transition-[opacity,filter] [&_img]:transition-[opacity,filter] [&_svg]:duration-300 [&_img]:duration-300 hover:[&_svg]:opacity-70 hover:[&_img]:opacity-70 dark:hover:[&_svg]:opacity-90 dark:hover:[&_img]:opacity-90 flex items-center gap-3 px-10 text-sm font-semibold tracking-wider whitespace-nowrap text-[var(--text-light-subtle)] transition-colors duration-300 hover:text-[var(--text-secondary)] dark:text-[var(--text-tertiary)]">
