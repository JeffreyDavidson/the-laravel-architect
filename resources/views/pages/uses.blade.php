...
@section('content')
    ...
    <x-hero-section>
        <div class="grid gap-6 md:grid-cols-[8rem_1fr] md:gap-10">
            <p class="text-brand-600 font-mono text-xs tracking-[0.18em] uppercase">Toolkit / 05</p>
            <div>
    ...
    <nav
        ...
        class="border-b border-gray-200 bg-white lg:hidden dark:border-[#1e2a3a] dark:bg-[#0b1016]"
    >
            ...
            <div class="flex flex-col gap-12 lg:flex-row">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <section id="content-creation" class="mb-16 scroll-mt-24">
                        <div class="mb-8 flex items-center gap-3">
                            <x-public.section-icon variant="accent">
                    ...
                    <section id="this-site" class="scroll-mt-24">
                        ...
                        <div class="grid grid-cols-2 border-y border-gray-200 sm:grid-cols-3 dark:border-[#1e2a3a]">
                            @foreach ([
