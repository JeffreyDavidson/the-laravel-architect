            ...
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="lg:w-80 flex-shrink-0 space-y-6">
                    ...
                    <div class="p-6 rounded-2xl border border-gray-200 dark:border-[#1e2a3a] bg-white dark:bg-[#0D1117]">
                        ...
                        <div class="space-y-3">
                            <a href="https://github.com/JeffreyDavidson" target="_blank" class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            ...
                            <a href="https://x.com/thelaravelarch" target="_blank" class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            ...
                            <a href="https://bsky.app/profile/thelaravelarch" target="_blank" class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                            ...
                            <a href="https://youtube.com/@thelaravelarchitect" target="_blank" class="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
