    ...
    <div class="rounded-xl border border-gray-950/5 dark:border-white/10 bg-white dark:bg-gray-900 p-5">
        ...
        @else
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                ...
                <div class="flex items-center gap-3 rounded-lg border border-gray-950/5 dark:border-white/5 px-4 py-3 hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                    <div class="flex h-8 w-8 items-center justify-center rounded-full flex-shrink-0
                        @if($activity['meta'] === 'Published') bg-emerald-500/10
                        @elseif($activity['meta'] === 'Pending Review') bg-amber-500/10
                        @elseif($activity['meta'] === 'Approved') bg-emerald-500/10
