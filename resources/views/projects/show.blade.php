...
<section class="noise-overlay relative overflow-hidden border-b border-[#1e2a3a]">
    {{-- Ambient glow --}}
    <div class="absolute top-1/3 left-1/4 w-[600px] h-[600px] rounded-full blur-[120px]" style="background: radial-gradient(circle, #4A7FBF, transparent 70%); animation: glowPulse 5s ease-in-out infinite;"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
            <div class="flex-1 min-w-0">
                ...
                <p class="text-lg md:text-xl text-gray-400 leading-relaxed mb-8 max-w-3xl">{{ $project->description }}</p>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <a href="{{ $project->github_url }}" target="_blank" class="link-btn inline-flex items-center gap-2 px-6 py-3 border border-[#1e2a3a] hover:border-gray-500 text-sm font-bold rounded-xl transition-colors bg-[#0D1117]">
            ...
            <div class="w-full lg:w-80 flex-shrink-0 space-y-6">
                ...
                <div class="p-6 rounded-2xl border border-[#1e2a3a] bg-[#0D1117]">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="tech-tag px-3 py-1.5 text-xs font-medium rounded-lg border border-[#1e2a3a] text-gray-400 bg-[#1e2a3a]/30">{{ $tech }}</span>
                        @endforeach
                    </div>
                </div>
                @endif
                ...
                <div class="p-6 rounded-2xl border border-[#1e2a3a] bg-[#0D1117]">
                    ...
                    <div class="space-y-3">
                        @if($project->url)
                        <a href="{{ $project->url }}" target="_blank" class="flex items-center gap-3 text-sm text-gray-400 hover:text-[#4A7FBF] transition-colors">
                        ...
                        @endif
                        @if($project->github_url)
                        <a href="{{ $project->github_url }}" target="_blank" class="flex items-center gap-3 text-sm text-gray-400 hover:text-[#4A7FBF] transition-colors">
...
<section class="border-t border-[#1e2a3a]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="{{ route('projects.show', $other) }}" class="related-card group block p-6 rounded-2xl border border-[#1e2a3a] bg-[#0D1117]/50">
