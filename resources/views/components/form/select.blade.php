...
@php($selectClasses = $variant === 'compact'
    ? 'w-full appearance-none rounded-lg border bg-white px-3 py-2.5 pr-10 text-base text-gray-900 outline-none transition-all focus:ring-1 dark:bg-surface-control dark:text-gray-200'
