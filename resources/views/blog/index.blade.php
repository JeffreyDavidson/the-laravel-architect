            ...
            <aside class="space-y-8">
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('blog.category', $category) }}" class="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                                <span>{{ $category->name }}</span>
                                <span class="text-xs bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">{{ $category->posts_count }}</span>
                            </a>
                        </li>
                        @endforeach
                    </ul>
